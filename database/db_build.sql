...
DROP TABLE IF EXISTS books, users, reservations CASCADE;
...
INSERT INTO books (title, author, owner, summary) VALUES
('Book Title 1', 'Author 1', 'Mohamed', 'A short book about nothing much'),
('Book Title 2', 'Author 2', 'Mohamed', 'A book about nothing much'),
('Book Title 3', 'Author 3', 'Matt', 'A short book about nothing much');
